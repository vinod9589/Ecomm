...
function Chikankari() {
    ...
    const getData=()=>{
        axios.get("http://localhost:5001/api/addproductadmin").then((res)=>setList(res.data.data.filter((i)=>i.catagery==="Chikankari")))
    }
  return (
    <div>
       <Header></Header>
       ...
       <div className='newarrivals'>
            <label style={{fontSize:"20px",color:"#543b29"}}>CHIKANKARI</label>
        </div>
