...
function Kurtis() {
  ...
  const getData=()=>{
    axios.get("http://localhost:5001/api/addproductadmin").then((res)=>setList(res.data.data.filter((i)=>i.catagery===" Kurtis")))
  }
  return (
    <div>
      <Header></Header>
      <div className='newarrivals'>
            <label style={{fontSize:"20px",color:""}}>KURTIS</label>
        </div>
